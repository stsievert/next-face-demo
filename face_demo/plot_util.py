...
def make_description_div():
    return Div(text="""<font style="color:gray;font-size:150%; margin-bottom: 10px;">Begin by starting the webcam. Once the webcam is started, take a picture and your emotion will be predicted and plotted on the map!</font>""", width=1500, height=10)
