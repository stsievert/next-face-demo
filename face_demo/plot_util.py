...
def make_image_base_input():
    return TextInput(
        value=default_base64, title="[JavaScript] Base64 Image Representation:"
    )
    # Callback
...
def make_title_div():
    return Div(
        text="""<b style="color:black;font-size:500%;">NEXT Face Demo</b>""",
        width=1000,
        height=60,
    )
...
def make_description_div():
    return Div(
        text="""<font style="color:gray;font-size:150%; margin-bottom: 10px;"> </font>""",
        width=1500,
        height=10,
    )
